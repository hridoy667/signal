  ...
  return (
    <article className="rounded-2xl border border-white/[0.07] bg-white/[0.025] shadow-[0_0_0_1px_rgba(255,255,255,0.02)] backdrop-blur-sm">
      <div className="flex gap-3 p-4">
        <div
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-zinc-600 to-zinc-800 text-xs font-semibold text-white"
          aria-hidden
        >
          {post.avatarUrl ? (
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
            <span className="font-medium text-white">{authorName(post)}</span>
      ...
      <div className="flex flex-wrap items-center gap-2 border-t border-white/[0.06] px-3 py-2.5">
        <div className="flex items-center gap-0.5 rounded-xl bg-white/[0.04] p-0.5">
          <VoteIconBtn
            ...
            variant="up"
          />
          <span className="min-w-[1.75rem] px-1 text-center text-xs tabular-nums text-white/55">
            {Math.round(up)}
          </span>
          <VoteIconBtn
            title="Downvote"
          ...
          <VoteIconBtn
            ...
            variant="neutral"
          />
          <span className="min-w-[1.75rem] px-1 text-center text-xs tabular-nums text-white/40">
            {Math.round(neu)}
          </span>
        </div>
        <button
