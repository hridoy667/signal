    ...
    <main className="relative flex-1 overflow-hidden px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <h1 className="font-display mt-4 text-4xl font-extrabold tracking-tight text-zinc-950 sm:text-5xl dark:text-white">
          Local voices, <span className="text-gradient">clear signal</span>
        </h1>
        <div className="mt-10 space-y-6 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
          <p>
            Signal combines a location-aware community feed with real-time chat
            so neighbors can share updates, weigh in with votes, and coordinate
            when it counts — without the noise of a generic global timeline.
          </p>
          <p>
            The stack is built for maintainability: typed API clients, reusable
            UI primitives, and theme-aware layouts so you can ship features
